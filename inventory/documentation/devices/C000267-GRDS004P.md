...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet53/1 | P2P_LINK_TO_C000267-009R601P_Ethernet3/4/1 | routed | - | 192.168.3.13/31 | default | 1500 | False | - | - |
| Ethernet54/1 | P2P_LINK_TO_C000267-014R602P_Ethernet3/4/1 | routed | - | 192.168.3.15/31 | default | 1500 | False | - | - |
...
interface Ethernet53/1
   description P2P_LINK_TO_C000267-009R601P_Ethernet3/4/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
interface Ethernet54/1
   description P2P_LINK_TO_C000267-014R602P_Ethernet3/4/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.200.4/32 |
| Loopback10 | VRF_INTERNAL_VTEP_DIAGNOSTICS | VRF_INTERNAL | 167.84.63.4/32 |
| Loopback20 | VRF_IOTBMS_VTEP_DIAGNOSTICS | VRF_IOTBMS | 167.84.63.4/32 |
| Loopback30 | VRF_GUEST_VTEP_DIAGNOSTICS | VRF_GUEST | 167.84.141.4/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan304 | 000267-Manila-Data | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan304 |  VRF_INTERNAL  |  -  |  10.67.4.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan304 | VRF_INTERNAL | - | fd00:82:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan304
   ...
   ip address virtual 10.67.4.1/24
!
interface Vlan600
...
!
interface Vxlan1
   description C000267-GRDS004P_VTEP
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 192.168.100.4 | enabled | Ethernet53/1 <br> Ethernet54/1 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 304 | 192.168.100.4:10304 | 10304:10304 | - | - | learned<br>dot1x |
| 600 | 192.168.100.4:10600 | 10600:10600 | - | - | learned<br>dot1x |
| 601 | 192.168.100.4:10601 | 10601:10601 | - | - | learned<br>dot1x |
| 610 | 192.168.100.4:10610 | 10610:10610 | - | - | learned<br>dot1x |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_GUEST | 192.168.100.4:301 | connected |
| VRF_INTERNAL | 192.168.100.4:101 | connected |
| VRF_IOTBMS | 192.168.100.4:201 | connected |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.200.4:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.200.4:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.200.4:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.200.4:1
```
...
| -------------- | --------------------- |
| VRF_GUEST | 167.84.141.4 |
| VRF_INTERNAL | 167.84.63.4 |
| VRF_IOTBMS | 167.84.63.4 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF_GUEST address 167.84.141.4
ip address virtual source-nat vrf VRF_INTERNAL address 167.84.63.4
ip address virtual source-nat vrf VRF_IOTBMS address 167.84.63.4
```
