...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.159/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1/1 | P2P_LINK_TO_C000267-009R601P_Ethernet4/28/1 | routed | - | 192.168.3.233/31 | default | 1500 | False | - | - |
| Ethernet2/1/1 | P2P_LINK_TO_C000267-014R602P_Ethernet4/28/1 | routed | - | 192.168.3.235/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1/1
   description P2P_LINK_TO_C000267-009R601P_Ethernet4/28/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
interface Ethernet2/1/1
   description P2P_LINK_TO_C000267-014R602P_Ethernet4/28/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.100.59/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.200.59/32 |
| Loopback10 | VRF_INTERNAL_VTEP_DIAGNOSTICS | VRF_INTERNAL | 167.84.63.59/32 |
| Loopback20 | VRF_IOTBMS_VTEP_DIAGNOSTICS | VRF_IOTBMS | 167.84.63.59/32 |
| Loopback30 | VRF_GUEST_VTEP_DIAGNOSTICS | VRF_GUEST | 167.84.141.59/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 192.168.100.59/32
   ip ospf area 0.0.0.0
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 192.168.200.59/32
   ip ospf area 0.0.0.0
!
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan359 | 000267-Manila-Data | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan359 |  VRF_INTERNAL  |  -  |  10.67.204.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan359 | VRF_INTERNAL | - | fd00:82:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan359
   ...
   ip address virtual 10.67.204.1/24
!
interface Vlan600
...
!
interface Vxlan1
   description C000267-020S059P_VTEP
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 192.168.100.59 | enabled | Ethernet1/1/1 <br> Ethernet2/1/1 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 359 | 192.168.100.59:10359 | 10359:10359 | - | - | learned<br>dot1x |
| 600 | 192.168.100.59:10600 | 10600:10600 | - | - | learned<br>dot1x |
| 601 | 192.168.100.59:10601 | 10601:10601 | - | - | learned<br>dot1x |
| 610 | 192.168.100.59:10610 | 10610:10610 | - | - | learned<br>dot1x |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_GUEST | 192.168.100.59:301 | connected |
| VRF_INTERNAL | 192.168.100.59:101 | connected |
| VRF_IOTBMS | 192.168.100.59:201 | connected |
...
router bgp 65001
   ...
   !
   vlan 359
      rd 192.168.100.59:10359
      route-target both 10359:10359
      redistribute dot1x
      redistribute learned
   !
   vlan 600
      rd 192.168.100.59:10600
      route-target both 10600:10600
      redistribute dot1x
      redistribute learned
   !
   vlan 601
      rd 192.168.100.59:10601
      route-target both 10601:10601
      redistribute dot1x
      redistribute learned
   !
   vlan 610
      rd 192.168.100.59:10610
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.200.59:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.200.59:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.200.59:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.200.59:1
```
...
| -------------- | --------------------- |
| VRF_GUEST | 167.84.141.59 |
| VRF_INTERNAL | 167.84.63.59 |
| VRF_IOTBMS | 167.84.63.59 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF_GUEST address 167.84.141.59
ip address virtual source-nat vrf VRF_INTERNAL address 167.84.63.59
ip address virtual source-nat vrf VRF_IOTBMS address 167.84.63.59
```
