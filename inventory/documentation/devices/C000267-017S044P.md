...
| Loopback10 | VRF_INTERNAL_VTEP_DIAGNOSTICS | VRF_INTERNAL | 167.84.63.44/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan344 | 000267-Manila-Data | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan344 |  VRF_INTERNAL  |  -  |  10.67.171.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan344 | VRF_INTERNAL | - | fd00:82:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan344
   ...
   ip address virtual 10.67.171.1/24
!
interface Vlan600
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 344 | 192.168.100.44:10344 | 10344:10344 | - | - | learned<br>dot1x |
...
| VRF_INTERNAL | 192.168.100.44:101 | connected |
...
router bgp 65001
   ...
   !
   vlan 344
      rd 192.168.100.44:10344
      route-target both 10344:10344
      redistribute dot1x
...
ip address virtual source-nat vrf VRF_INTERNAL address 167.84.63.44
