...
| ------- | ---- | ------------ |
| 309 | C000267-Manila-Data | - |
| 310 | 160479-410MANILA-Voice | - |
| 500 | Mistedge | - |
| 600 | Guest_Wireless | - |
| 601 | Guest_Wired | - |
| 610 | IOT_WIRELESS | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.200.61/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan309 | C000267-Manila-Data | VRF_INTERNAL | - | False |
| Vlan310 | 160479-410MANILA-Voice | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan309 |  VRF_INTERNAL  |  -  |  10.4.3.129/25  |  -  |  -  |  -  |  -  |
| Vlan310 |  VRF_INTERNAL  |  -  |  10.4.105.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan309 | VRF_INTERNAL | - | fd00:83:0::1/64 | - | - | - | - | - | - | - |
| Vlan310 | VRF_INTERNAL | - | fd00:83:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan309
   ...
   ip address virtual 10.4.3.129/25
!
interface Vlan310
   description 160479-410MANILA-Voice
   no shutdown
   vrf VRF_INTERNAL
   ip helper-address 169.86.42.100
   ip helper-address 169.86.42.132
   ...
   ipv6 enable
   ipv6 address virtual fd00:83:0::1/64
   ip address virtual 10.4.105.1/24
!
interface Vlan500
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 192.168.100.61 | enabled | Ethernet1/1/1 <br> Ethernet2/1/1 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 309 | 192.168.100.61:10309 | 10309:10309 | - | - | learned<br>dot1x |
| 310 | 192.168.100.61:10310 | 10310:10310 | - | - | learned<br>dot1x |
...
router bgp 65001
   ...
   !
   vlan 309
      rd 192.168.100.61:10309
      route-target both 10309:10309
      redistribute dot1x
      redistribute learned
   !
   vlan 310
      rd 192.168.100.61:10310
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.200.61:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.200.61:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.200.61:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.200.61:1
```
