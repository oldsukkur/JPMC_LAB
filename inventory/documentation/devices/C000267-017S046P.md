...
| Loopback10 | VRF_INTERNAL_VTEP_DIAGNOSTICS | VRF_INTERNAL | 167.84.63.46/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan346 | 000267-Manila-Data | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan346 |  VRF_INTERNAL  |  -  |  10.67.173.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan346 | VRF_INTERNAL | - | fd00:82:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan346
   ...
   ip address virtual 10.67.173.1/24
!
interface Vlan600
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 346 | 192.168.100.46:10346 | 10346:10346 | - | - | learned<br>dot1x |
...
| VRF_INTERNAL | 192.168.100.46:101 | connected |
...
router bgp 65001
   ...
   !
   vlan 346
      rd 192.168.100.46:10346
      route-target both 10346:10346
      redistribute dot1x
...
ip address virtual source-nat vrf VRF_INTERNAL address 167.84.63.46
