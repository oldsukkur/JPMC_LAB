...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet53/1 | P2P_LINK_TO_C000267-009R601P_Ethernet3/1/1 | routed | - | 192.168.3.1/31 | default | 1500 | False | - | - |
| Ethernet54/1 | P2P_LINK_TO_C000267-014R602P_Ethernet3/1/1 | routed | - | 192.168.3.3/31 | default | 1500 | False | - | - |
...
interface Ethernet53/1
   description P2P_LINK_TO_C000267-009R601P_Ethernet3/1/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
interface Ethernet54/1
   description P2P_LINK_TO_C000267-014R602P_Ethernet3/1/1
   no shutdown
   mtu 1500
   speed forced 100g
   no switchport
...
| Loopback10 | VRF_INTERNAL_VTEP_DIAGNOSTICS | VRF_INTERNAL | 167.84.63.1/32 |
| Loopback20 | VRF_IOTBMS_VTEP_DIAGNOSTICS | VRF_IOTBMS | 167.84.63.1/32 |
| Loopback30 | VRF_GUEST_VTEP_DIAGNOSTICS | VRF_GUEST | 167.84.141.1/32 |
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan301 | C000267-Manila-Data | VRF_INTERNAL | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan301 |  VRF_INTERNAL  |  -  |  10.67.1.1/24  |  -  |  -  |  -  |  -  |
...
| --------- | --- | ------------ | ---------------------- | ---------------------- | ---- | -------------- | ------------------- | ----------------- | ----------- | ------------ |
| Vlan301 | VRF_INTERNAL | - | fd00:82:0::1/64 | - | - | - | - | - | - | - |
...
interface Vlan301
   ...
   ip address virtual 10.67.1.1/24
!
interface Vlan600
...
!
interface Vxlan1
   description C000267-GRDS001P_VTEP
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 192.168.100.1 | enabled | Ethernet53/1 <br> Ethernet54/1 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 301 | 192.168.100.1:10301 | 10301:10301 | - | - | learned<br>dot1x |
| 600 | 192.168.100.1:10600 | 10600:10600 | - | - | learned<br>dot1x |
| 601 | 192.168.100.1:10601 | 10601:10601 | - | - | learned<br>dot1x |
| 610 | 192.168.100.1:10610 | 10610:10610 | - | - | learned<br>dot1x |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_GUEST | 192.168.100.1:301 | connected |
| VRF_INTERNAL | 192.168.100.1:101 | connected |
| VRF_IOTBMS | 192.168.100.1:201 | connected |
...
| -------------- | --------------------- |
| VRF_GUEST | 167.84.141.1 |
| VRF_INTERNAL | 167.84.63.1 |
| VRF_IOTBMS | 167.84.63.1 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF_GUEST address 167.84.141.1
ip address virtual source-nat vrf VRF_INTERNAL address 167.84.63.1
ip address virtual source-nat vrf VRF_IOTBMS address 167.84.63.1
```
